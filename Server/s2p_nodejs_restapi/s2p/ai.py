...
with tf.device(strg0):
    dull_head = load_model('./s2p/models/dull_head.net', compile=False)
    gate_head = load_model('./s2p/models/gate_head.net', compile=False)
    line_head = load_model('./s2p/models/line_head.net', compile=False)
    noise_tail = load_model('./s2p/models/noise_tail.net', compile=False)
    clear_tail = load_model('./s2p/models/clear_tail.net', compile=False)

with tf.device(strg1):
    base_head = load_model('./s2p/models/base_head.net', compile=False)
    base_neck = load_model('./s2p/models/base_neck.net', compile=False)
    base_reader = load_model('./s2p/models/base_reader.net', compile=False)
...
dull_head.load_weights('./s2p/models/dull_head.net')
gate_head.load_weights('./s2p/models/gate_head.net')
line_head.load_weights('./s2p/models/line_head.net')
base_head.load_weights('./s2p/models/base_head.net')
base_neck.load_weights('./s2p/models/base_neck.net')
noise_tail.load_weights('./s2p/models/noise_tail.net')
clear_tail.load_weights('./s2p/models/clear_tail.net')
base_reader.load_weights('./s2p/models/base_reader.net')
